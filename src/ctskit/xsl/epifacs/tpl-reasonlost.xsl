  ...
  <xsl:template name="lost-opener">
    ...
    <xsl:choose>
      ...
      <xsl:when test="current()[not(preceding-sibling::t:*)]
                                       [not(preceding-sibling::node()[1][self::text()]) or preceding-sibling::node()[1]
                                       [self::text() and translate(normalize-space(.), ' ', '') = '']]
                                       /parent::t:*[not(local-name() = 'ab' or local-name() ='egXML' or local-name()='l' or local-name()='item')][preceding-sibling::t:*[1]]
                                       [not(preceding-sibling::node()[1][self::text()]) or preceding-sibling::node()[1]
                                       [self::text() and translate(normalize-space(.), ' ', '') = '']]
                                       /preceding-sibling::t:*[1]/t:*[@reason='lost'][not(following-sibling::t:*)]">
      ...
      <xsl:when test="current()[not(preceding-sibling::t:*)]
                                            [not(preceding-sibling::node()[1][self::text()]) or preceding-sibling::node()[1]
                                            [self::text() and translate(normalize-space(.), ' ', '') = '']]
                                            /parent::t:*[not(local-name() = 'ab' or local-name()='egXML' or local-name()='l' or local-name()='item')][not(preceding-sibling::t:*)]
                                            [not(preceding-sibling::node()[1][self::text()]) or preceding-sibling::node()[1]
                                            [self::text() and translate(normalize-space(.), ' ', '') = '']]
                                            /parent::t:*[not(local-name() = 'ab' or local-name()='egXML' or local-name()='l' or local-name()='item')][preceding-sibling::t:*[1]]
                                            [not(preceding-sibling::node()[1][self::text()]) or preceding-sibling::node()[1]
  ...
  <xsl:template name="lost-closer">
    ...
    <xsl:choose>
      ...
      <xsl:when test="current()[not(following-sibling::t:*)]   
                                          ...
                                          [self::text() and translate(normalize-space(.), ' ', '') = '']]    
                                          /parent::t:*[not(local-name() = 'ab' or local-name() ='egXML' or local-name() ='l' or local-name()='item')][following-sibling::t:*[1]]     
                                          [not(following-sibling::node()[1][self::text()]) or following-sibling::node()[1]
                                          [self::text() and translate(normalize-space(.), ' ', '') = '']]    
                                          /following-sibling::t:*[1]/t:*[@reason='lost'][not(preceding-sibling::t:*)]">
            <xsl:if test="parent::t:*/preceding-sibling::t:*[1]    
      ...
      <xsl:when test="current()[not(following-sibling::t:*)]    
                                           [not(following-sibling::node()[1][self::text()]) or following-sibling::node()[1]
                                           [self::text() and translate(normalize-space(.), ' ', '') = '']]    
                                           /parent::t:*[not(local-name() = 'ab') and not(local-name()='egXML') and not(local-name()='l') and not(local-name='item')][not(following-sibling::t:*)]      
                                           [not(following-sibling::node()[1][self::text()]) or following-sibling::node()[1]
                                           [self::text() and translate(normalize-space(.), ' ', '') = '']]     
                                           /parent::t:*[not(local-name() = 'ab') and not(local-name() = 'egXML') and not(local-name() ='l') and not(local-name()='item')][following-sibling::t:*[1]]    
                                           [not(following-sibling::node()[1][self::text()]) or following-sibling::node()[1]
                                           [self::text() and translate(normalize-space(.), ' ', '') = '']]    
                                           /following-sibling::t:*[1]     
                                           /t:*[@reason='lost'][not(preceding-sibling::t:*)]">
      ...
      <xsl:when test="current()[not(following-sibling::t:*)]    
                                             [not(following-sibling::node()[1][self::text()]) or following-sibling::node()[1]
                                             [self::text() and translate(normalize-space(.), ' ', '') = '']]  
                                             /parent::t:*[not(local-name() = 'ab' or local-name()='egXML' or local-name()='l' or local-name()='item')][not(following-sibling::t:*)]     
                                             [not(following-sibling::node()[1][self::text()]) or following-sibling::node()[1]
                                             [self::text() and translate(normalize-space(.), ' ', '') = '']]     
                                             /parent::t:*[not(local-name() = 'ab' or local-name()='egXML' or local-name()='l' or local-name()='item')][following-sibling::t:*[1]]      
                                             [not(following-sibling::node()[1][self::text()]) or following-sibling::node()[1]
